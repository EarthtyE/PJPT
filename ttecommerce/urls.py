...
urlpatterns = [
    ...
    path('product/<slug:category_slug>/<slug:product_slug>',views.productPage,name='productDetils'),
...
if settings.DEBUG :
    ...
    # /static//media/product/ชื่อรูปภาพ เช่น 1.png